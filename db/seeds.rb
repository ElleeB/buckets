...
BucketItem.create(
  ...
  due_date: DateTime.strptime('03/2/4934', '%m/%d/%Y')
  )
...
BucketItem.create(
  ...
  due_date: DateTime.strptime('01/1/4933', '%m/%d/%Y')
  )
...
BucketItem.create(
  ...
  due_date: DateTime.strptime('09/30/4934', '%m/%d/%Y')
  )
...
BucketItem.create(
  ...
  due_date: DateTime.strptime('12/28/4931', '%m/%d/%Y')
  )
